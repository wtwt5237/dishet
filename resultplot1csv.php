...
if (!empty($jobid) && $result = $db_conn->prepare("SELECT Proportion_csv FROM DisHetResults WHERE JobID = ?")) {
    ...
    if($resultgene){
        ...
        header("Content-Disposition: attachment; filename=ProportionExp.csv");
