...
$resultgene = "";
if (!empty($jobid) && $result = $db_conn->prepare("SELECT StromaExp_jpg FROM DisHetResults WHERE JobID = ?")) {
    ...
    if ($resultgene) {
        ...
        header("Content-Disposition: attachment; filename=StromaExpImage.jpg");
